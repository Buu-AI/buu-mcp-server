...
if (!BUU_TEAM_API_KEY) {
    ...
    console.error("Please set the BUU_TEAM_API_KEY environment variable or use 'env BUU_TEAM_API_KEY=your_key npx -y buu-server-mcp'");
    process.exit(1);
}
const buuServerClient = new GraphQLClient(BUU_SERVER_URL, {
    headers: {
